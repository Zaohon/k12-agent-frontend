  ...
  <div class="category-content">
    ...
    <div class="section-card">
      <div class="section-header">
        <div class="section-left">
          <div class="section-title-row">
            ...
            <div class="section-title">精选专题</div>
          </div>
      ...
      <div class="agent-card-grid">
        ...
        <!-- 空卡片（最多3个智能体） -->
        <div v-if="section2Agents.length < 3" class="agent-card-empty" @click="openAgentDialog">
          <span>+ 关联智能体</span>
        </div>
      </div>
    </div>
...
const loadAgents = async () => {
  ...
  ENABLE_LOG && console.log('推荐页 - 加载分类智能体, categoryId=', props.categoryId)
...
const handleSave = async () => {
  ...
  ENABLE_LOG && console.log('推荐页 - 保存智能体, categoryId=', props.categoryId, ', agentIds=', agentIds)
